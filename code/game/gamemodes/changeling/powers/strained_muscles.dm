...
/obj/effect/proc_holder/spell/changeling/strained_muscles
...
/obj/effect/proc_holder/spell/changeling/strained_muscles/sting_action(var/mob/living/carbon/user)
	enabled = !enabled
	if(enabled)
