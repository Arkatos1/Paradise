/obj/effect/proc_holder/spell/changeling/biodegrade
	name = "Biodegrade"
...
/obj/effect/proc_holder/spell/changeling/biodegrade/sting_action(mob/living/carbon/human/user)
...
/obj/effect/proc_holder/spell/changeling/biodegrade/proc/dissolve_handcuffs(mob/living/carbon/human/user, obj/O)
...
/obj/effect/proc_holder/spell/changeling/biodegrade/proc/dissolve_straightjacket(mob/living/carbon/human/user, obj/S)
...
/obj/effect/proc_holder/spell/changeling/biodegrade/proc/open_closet(mob/living/carbon/human/user, obj/structure/closet/C)
	if(C && user.loc == C)
...
/obj/effect/proc_holder/spell/changeling/biodegrade/proc/dissolve_cocoon(mob/living/carbon/human/user, obj/structure/spider/cocoon/C)
	if(C && user.loc == C)
