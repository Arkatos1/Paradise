/obj/effect/proc_holder/spell/changeling/chameleon_skin
	name = "Chameleon Skin"
...
/obj/effect/proc_holder/spell/changeling/chameleon_skin/sting_action(mob/user)
...
/obj/effect/proc_holder/spell/changeling/chameleon_skin/on_refund(mob/user)
