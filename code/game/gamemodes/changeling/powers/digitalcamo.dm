/obj/effect/proc_holder/spell/changeling/digitalcamo
	...
	action_icon_state = "digital_camo"
	dna_cost = 1

//Prevents AIs tracking you but makes you easily detectable to the human-eye.
/obj/effect/proc_holder/spell/changeling/digitalcamo/sting_action(var/mob/user)
