/obj/effect/proc_holder/spell/changeling/sting
	name = "Tiny Prick"
	desc = "Stabby stabby"
	var/sting_icon = null

/obj/effect/proc_holder/spell/changeling/sting/Click()
	var/mob/user = usr
...
/obj/effect/proc_holder/spell/changeling/sting/proc/set_sting(var/mob/user)
...
/obj/effect/proc_holder/spell/changeling/sting/proc/unset_sting(var/mob/user)
...
/obj/effect/proc_holder/spell/changeling/sting/can_sting(var/mob/user, var/mob/target)
	if(!..())
		return
	if(!user.mind.changeling.chosen_sting)
...
/obj/effect/proc_holder/spell/changeling/sting/sting_feedback(var/mob/user, var/mob/target)
	if(!target)
		return
...
/obj/effect/proc_holder/spell/changeling/sting/transformation
	...
	action_icon_state = "sting_transform"
...
/obj/effect/proc_holder/spell/changeling/sting/transformation/Click()
	var/mob/user = usr
...
/obj/effect/proc_holder/spell/changeling/sting/transformation/can_sting(var/mob/user, var/mob/target)
	if(!..())
		return
...
/obj/effect/proc_holder/spell/changeling/sting/transformation/sting_action(var/mob/user, var/mob/target)
...
obj/effect/proc_holder/spell/changeling/sting/extract_dna
	name = "Extract DNA Sting"
	desc = "We stealthily sting a target and extract their DNA."
	helptext = "Will give you the DNA of your target, allowing you to transform into them."
	charge_max = 250
	action_icon_state = "sting_extract"
	sting_icon = "sting_extract"
	chemical_cost = 25
	dna_cost = 0

/obj/effect/proc_holder/spell/changeling/sting/extract_dna/can_sting(var/mob/user, var/mob/target)
	if(..())
		return user.mind.changeling.can_absorb_dna(user, target)

/obj/effect/proc_holder/spell/changeling/sting/extract_dna/sting_action(var/mob/user, var/mob/living/carbon/human/target)
...
obj/effect/proc_holder/spell/changeling/sting/mute
	name = "Mute Sting"
	desc = "We silently sting a human, completely silencing them for a short time."
	helptext = "Does not provide a warning to the victim that they have been stung, until they try to speak and cannot."
	action_icon_state = "sting_mute"
	sting_icon = "sting_mute"
	chemical_cost = 20
	dna_cost = 2

/obj/effect/proc_holder/spell/changeling/sting/mute/sting_action(var/mob/user, var/mob/living/carbon/target)
	add_attack_logs(user, target, "Mute sting (changeling)")
	target.AdjustSilence(30)
	feedback_add_details("changeling_powers","MS")
	return 1

obj/effect/proc_holder/spell/changeling/sting/blind
	name = "Blind Sting"
...
/obj/effect/proc_holder/spell/changeling/sting/blind/sting_action(var/mob/living/user, var/mob/living/target)
...
obj/effect/proc_holder/spell/changeling/sting/LSD
	name = "Hallucination Sting"
	desc = "Causes terror in the target."
	helptext = "We evolve the ability to sting a target with a powerful hallucinogenic chemical. The target does not notice they have been stung, and the effect occurs after 30 to 60 seconds."
	action_icon_state = "sting_lsd"
	sting_icon = "sting_lsd"
	chemical_cost = 10
	dna_cost = 1

/obj/effect/proc_holder/spell/changeling/sting/LSD/sting_action(var/mob/user, var/mob/living/carbon/target)
...
obj/effect/proc_holder/spell/changeling/sting/cryo //Enable when mob cooling is fixed so that frostoil actually makes you cold, instead of mostly just hungry.
	name = "Cryogenic Sting"
	desc = "We silently sting a human with a cocktail of chemicals that freeze them."
	helptext = "Does not provide a warning to the victim, though they will likely realize they are suddenly freezing."
	action_icon_state = "sting_cryo"
	sting_icon = "sting_cryo"
	chemical_cost = 15
	dna_cost = 2

/obj/effect/proc_holder/spell/changeling/sting/cryo/sting_action(var/mob/user, var/mob/target)
