/obj/effect/proc_holder/spell/changeling/lesserform
	name = "Lesser form"
...
/obj/effect/proc_holder/spell/changeling/lesserform/sting_action(var/mob/living/carbon/human/user)
	...
	H.monkeyize()
	changeling.purchasedpowers += new /obj/effect/proc_holder/spell/changeling/humanform(null)
