...
/obj/effect/proc_holder/spell/changeling/augmented_eyesight
...
/obj/effect/proc_holder/spell/changeling/augmented_eyesight/sting_action(mob/living/carbon/human/user)
	if(!istype(user))
		return
...
/obj/effect/proc_holder/spell/changeling/augmented_eyesight/on_refund(mob/user)
