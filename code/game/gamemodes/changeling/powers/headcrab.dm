/obj/effect/proc_holder/spell/changeling/headcrab
	name = "Last Resort"
	desc = "We sacrifice our current body in a moment of need, placing us in control of a vessel."
	helptext = "We will be placed in control of a small, fragile creature. We may attack a corpse like this to plant an egg which will slowly mature into a new form for us."
	action_icon_state = "last_resort"
	chemical_cost = 20
	dna_cost = 1
	req_human = 1

/obj/effect/proc_holder/spell/changeling/headcrab/try_to_sting(mob/user, mob/target)
    if(alert("Are you sure you wish to do this? This action cannot be undone.",,"Yes","No")=="No")
        return
    ..()

/obj/effect/proc_holder/spell/changeling/headcrab/sting_action(mob/user)
